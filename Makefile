...
OBJECTS= floodit-board.o sdl-floodit-board.o sdl-buttons.o board-tree.o board-tree-gen.o board-tree-search.o sdl-ai-hook.o
...
sdl-ai-hook.o : sdl-ai-hook-inl.hh sdl-ai-hook.cc
	$(CXX) $*.cc -o $@ $(LIBFLAGS) $(CFLAGS)
